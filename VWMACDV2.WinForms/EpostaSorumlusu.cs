...
namespace VWMACDV2.WinForms
{
    class EpostaSorumlusu
    {
        public static void Gonder(string mesaj)
        {
            ...
            sc.Credentials = new NetworkCredential("adayazilim.isa@gmail.com", "kB*1928374655");
            ...
            mail.Attachments.Add(new Attachment(@"DOA- Acente_Police_XML_Ciktisi_20180608_0928_7041400.xml"));
